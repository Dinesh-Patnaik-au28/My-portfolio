...
const roles=[
  {company:"CXVERSE",period:"October 2022 → Present",role:"Software Engineer",focus:"Frontend Engineering | Mobile Systems | Product Development",details:["10+ production applications", "15+ websites", "200K+ users", "Application builds and releases", "OTA updates and Expo upgrades", "Production debugging"],badge:"Company Spotlight"},
  {company:"ATTAINU",period:"December 2021 → 2022",role:"Full Stack Developer Intern",focus:"Maintained a React-based Web Builder, handling fixes and feature updates while learning Node.js.",details:["Node.js", "Express", "React", "MongoDB", "Git"],badge:"Full-stack foundation"},
] as const;
