  ...
  return <section id="top" className="v5-hero v5-hero-final">
    ...
    <div className="v5-identity-hero">
      <div className="v5-hero-copy-final">
        ...
        <p>I like solving the messy parts behind a product, so what reaches the user feels simple, intuitive and effortless.</p>
      ...
      <div className={`v5-component-playground ${resolved?"resolved":""}`} ref={stage}>
        ...
        <div className="v5-play-core"><small>{resolved?"INTERFACE SETTLED":"SYSTEM IN MOTION"}</small><b>BUILT TO FEEL SIMPLE</b><i>{active.length}/4 COMPONENTS</i></div>
